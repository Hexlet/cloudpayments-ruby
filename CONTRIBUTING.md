...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/cloudpayments/helpers/` and `examples/` directory.
...
require_relative "../lib/cloudpayments"
...
```ruby
gem "cloudpayments", git: "https://github.com/stainless-sdks/cloudpayments-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/stainless-sdks/cloudpayments-ruby' '<path-to-repo>'
```

```ruby
gem "cloudpayments", path: "<path-to-repo>"
```
