...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/cloudpayments_ruby/helpers/` and `examples/` directory.
...
require_relative "../lib/cloudpayments_ruby"
...
```ruby
gem "cloudpayments-ruby", git: "https://github.com/Hexlet/cloudpayments-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/Hexlet/cloudpayments-ruby' '<path-to-repo>'
```

```ruby
gem "cloudpayments-ruby", path: "<path-to-repo>"
```
