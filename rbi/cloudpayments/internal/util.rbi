      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Cloudpayments::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Cloudpayments::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: Cloudpayments::Internal::Util::ParsedUri,
            rhs: Cloudpayments::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Cloudpayments::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  Cloudpayments::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
