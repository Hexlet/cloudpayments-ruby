  ...
  module Models
    ...
    module PaymentAuthResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Cloudpayments::Models::PaymentAuthResponse::UnionMember0,
            Cloudpayments::Models::PaymentAuthResponse::UnionMember1
          )
        end
      ...
      class UnionMember0 < Cloudpayments::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Cloudpayments::Models::PaymentAuthResponse::UnionMember0::Model
            )
          )
        end
        attr_reader :model
        ...
        sig do
          params(
            model:
              Cloudpayments::Models::PaymentAuthResponse::UnionMember0::Model::OrHash
          ).void
        end
        attr_writer :model
        ...
        class Model < Cloudpayments::Internal::Type::BaseModel
          ...
          sig do
            params(fall_back_scenario_declined_transaction_id: Integer).void
          end
      ...
      class UnionMember1 < Cloudpayments::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Cloudpayments::Models::PaymentAuthResponse::UnionMember1::Model
            )
          )
        end
        attr_reader :model
        ...
        sig do
          params(
            model:
              Cloudpayments::Models::PaymentAuthResponse::UnionMember1::Model::OrHash
          ).void
        end
        attr_writer :model
      ...
      sig do
        override.returns(
          T::Array[Cloudpayments::Models::PaymentAuthResponse::Variants]
        )
      end
      def self.variants
      end
