  ...
  module Models
    class PaymentPost3dsResponse < Cloudpayments::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Cloudpayments::Models::PaymentPost3dsResponse,
      ...
      sig do
        returns(T.nilable(Cloudpayments::Models::PaymentPost3dsResponse::Model))
      end
      attr_reader :model

      sig do
        params(
          model: Cloudpayments::Models::PaymentPost3dsResponse::Model::OrHash
        ).void
      end
      attr_writer :model
        ...
        override.returns(
          {
            success: T::Boolean,
            message: String,
            model: Cloudpayments::Models::PaymentPost3dsResponse::Model
          }
        )
      end
      def to_hash
      ...
      class Model < Cloudpayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Cloudpayments::Models::PaymentPost3dsResponse::Model,
              Cloudpayments::Internal::AnyHash
            )
          end
