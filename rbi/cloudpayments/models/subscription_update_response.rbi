  ...
  module Models
    class SubscriptionUpdateResponse < Cloudpayments::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Cloudpayments::Models::SubscriptionUpdateResponse,
      ...
      sig do
        returns(
          T.nilable(Cloudpayments::Models::SubscriptionUpdateResponse::Model)
        )
      end
      attr_reader :model
      ...
      sig do
        params(
          model:
            Cloudpayments::Models::SubscriptionUpdateResponse::Model::OrHash
        ).void
      end
      attr_writer :model
        ...
        override.returns(
          {
            success: T::Boolean,
            message: String,
            model: Cloudpayments::Models::SubscriptionUpdateResponse::Model
          }
        )
      end
      def to_hash
      ...
      class Model < Cloudpayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Cloudpayments::Models::SubscriptionUpdateResponse::Model,
              Cloudpayments::Internal::AnyHash
            )
          end
