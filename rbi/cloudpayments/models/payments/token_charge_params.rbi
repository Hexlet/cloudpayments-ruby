    ...
    module Payments
      class TokenChargeParams < Cloudpayments::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Cloudpayments::Payments::TokenChargeParams,
        ...
        sig do
          returns(T.nilable(Cloudpayments::Payments::TokenChargeParams::Payer))
        end
        attr_reader :payer
          ...
          override.returns(
            {
              ...
              ip_address: String,
              json_data: T.anything,
              payer: Cloudpayments::Payments::TokenChargeParams::Payer,
              payment_scheduled: Integer,
        ...
        class Payer < Cloudpayments::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Cloudpayments::Payments::TokenChargeParams::Payer,
                Cloudpayments::Internal::AnyHash
              )
            end
