  ...
  module Models
    class SubscriptionGetResponse < Cloudpayments::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Cloudpayments::Models::SubscriptionGetResponse,
      ...
      sig do
        returns(
          T.nilable(Cloudpayments::Models::SubscriptionGetResponse::Model)
        )
      end
      attr_reader :model
      ...
      sig do
        params(
          model: Cloudpayments::Models::SubscriptionGetResponse::Model::OrHash
        ).void
      end
      attr_writer :model
        ...
        override.returns(
          {
            success: T::Boolean,
            message: String,
            model: Cloudpayments::Models::SubscriptionGetResponse::Model
          }
        )
      end
      def to_hash
      ...
      class Model < Cloudpayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Cloudpayments::Models::SubscriptionGetResponse::Model,
              Cloudpayments::Internal::AnyHash
            )
          end
