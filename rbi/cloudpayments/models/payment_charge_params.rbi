...
module Cloudpayments
  module Models
    class PaymentChargeParams < Cloudpayments::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Cloudpayments::PaymentChargeParams,
      ...
      sig { returns(T.nilable(Cloudpayments::PaymentChargeParams::Payer)) }
      attr_reader :payer

      sig do
        params(payer: Cloudpayments::PaymentChargeParams::Payer::OrHash).void
      end
      attr_writer :payer
        ...
        override.returns(
          {
            ...
            json_data: T.anything,
            name: String,
            payer: Cloudpayments::PaymentChargeParams::Payer,
            payment_url: String,
            save_card: T::Boolean,
      ...
      class Payer < Cloudpayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Cloudpayments::PaymentChargeParams::Payer,
              Cloudpayments::Internal::AnyHash
            )
          end
