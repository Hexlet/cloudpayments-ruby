...
module Cloudpayments
  module Models
    class SubscriptionCreateResponse < Cloudpayments::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Cloudpayments::Models::SubscriptionCreateResponse::Model)
        )
      end
      attr_reader :model
      ...
      sig do
        params(
          model:
            Cloudpayments::Models::SubscriptionCreateResponse::Model::OrHash
        ).void
      end
      attr_writer :model
        ...
        override.returns(
          {
            success: T::Boolean,
            message: String,
            model: Cloudpayments::Models::SubscriptionCreateResponse::Model
          }
        )
      end
      def to_hash
      ...
      class Model < Cloudpayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Cloudpayments::Models::SubscriptionCreateResponse::Model,
              Cloudpayments::Internal::AnyHash
            )
          end
