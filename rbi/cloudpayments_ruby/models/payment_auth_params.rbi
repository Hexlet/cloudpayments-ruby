  ...
  module Models
    class PaymentAuthParams < CloudpaymentsRuby::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            CloudpaymentsRuby::PaymentAuthParams,
      ...
      sig { returns(T.nilable(CloudpaymentsRuby::PaymentAuthParams::Payer)) }
      attr_reader :payer

      sig do
        params(payer: CloudpaymentsRuby::PaymentAuthParams::Payer::OrHash).void
      end
      attr_writer :payer
      ...
      class Payer < CloudpaymentsRuby::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              CloudpaymentsRuby::PaymentAuthParams::Payer,
              CloudpaymentsRuby::Internal::AnyHash
            )
          end
