...
module CloudpaymentsRuby
  module Models
    module Payments
      class TokenChargeParams < CloudpaymentsRuby::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              CloudpaymentsRuby::Payments::TokenChargeParams,
        ...
        sig do
          returns(
            T.nilable(CloudpaymentsRuby::Payments::TokenChargeParams::Payer)
          )
        end
        attr_reader :payer
        ...
        sig do
          params(
            payer: CloudpaymentsRuby::Payments::TokenChargeParams::Payer::OrHash
          ).void
        end
        attr_writer :payer
        ...
        class Payer < CloudpaymentsRuby::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                CloudpaymentsRuby::Payments::TokenChargeParams::Payer,
                CloudpaymentsRuby::Internal::AnyHash
              )
            end
