      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            CloudpaymentsRuby::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: CloudpaymentsRuby::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: CloudpaymentsRuby::Internal::Util::ParsedUri,
            rhs: CloudpaymentsRuby::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[CloudpaymentsRuby::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  CloudpaymentsRuby::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
