    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            params(child: CloudpaymentsRuby::Internal::Type::BaseModel).void
          end
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  CloudpaymentsRuby::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  CloudpaymentsRuby::Internal::Type::BaseModel::KnownField,
                  { type: CloudpaymentsRuby::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: CloudpaymentsRuby::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(CloudpaymentsRuby::Internal::AnyHash) }
        def to_h
        end
