...
module Cloudpayments
  module Resources
    class Orders
      ...
      #
      # @return [Cloudpayments::Models::OrderCreateResponse]
      #
      # @see Cloudpayments::Models::OrderCreateParams
      def create(params)
        parsed, options = Cloudpayments::OrderCreateParams.dump_request(params)
        @client.request(
          method: :post,
          path: "orders/create",
          body: parsed,
          model: Cloudpayments::Models::OrderCreateResponse,
          options: options
        )
      end
      ...
      # @param request_options [Cloudpayments::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Cloudpayments::Models::OrderCancelResponse]
      #
      # @see Cloudpayments::Models::OrderCancelParams
      def cancel(params)
        parsed, options = Cloudpayments::OrderCancelParams.dump_request(params)
        @client.request(
          method: :post,
          path: "orders/cancel",
          body: parsed,
          model: Cloudpayments::Models::OrderCancelResponse,
          options: options
        )
      end
