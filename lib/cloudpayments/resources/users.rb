...
module Cloudpayments
  module Resources
    class Users
      ...
      #
      # @return [Cloudpayments::Models::User]
      #
      # @see Cloudpayments::Models::UserCreateParams
      def create(params = {})
        parsed, options = Cloudpayments::UserCreateParams.dump_request(params)
        @client.request(
          method: :post,
          path: "user",
          body: parsed,
          model: Cloudpayments::User,
          options: options
        )
      end
      ...
      # @return [Cloudpayments::Models::User]
      #
      # @see Cloudpayments::Models::UserRetrieveParams
      ...
      # @return [nil]
      #
      # @see Cloudpayments::Models::UserUpdateParams
      def update(existing_username, params = {})
        parsed, options = Cloudpayments::UserUpdateParams.dump_request(params)
        @client.request(
          method: :put,
      ...
      # @return [nil]
      #
      # @see Cloudpayments::Models::UserDeleteParams
      ...
      # @return [Cloudpayments::Models::User]
      #
      # @see Cloudpayments::Models::UserCreateWithListParams
      def create_with_list(params = {})
        parsed, options = Cloudpayments::UserCreateWithListParams.dump_request(params)
        @client.request(
          method: :post,
      ...
      # @return [String]
      #
      # @see Cloudpayments::Models::UserLoginParams
      def login(params = {})
        parsed, options = Cloudpayments::UserLoginParams.dump_request(params)
      ...
      # @return [nil]
      #
      # @see Cloudpayments::Models::UserLogoutParams
      def logout(params = {})
