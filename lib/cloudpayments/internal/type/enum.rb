    ...
    module Type
      ...
      module Enum
        ...
        def ==(other)
          ...
          Cloudpayments::Internal::Type::Enum === other && other.values.to_set == values.to_set
        ...
        # @return [Object]
        def to_sorbet_type
          types = values.map { Cloudpayments::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1) }.uniq
          case types
          in []
            T.noreturn
          in [type]
        ...
        def inspect(depth: 0)
          ...
          members = values.map { Cloudpayments::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
