    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Cloudpayments::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Cloudpayments::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Cloudpayments::FilePart.new(value)
          in Cloudpayments::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Cloudpayments::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Cloudpayments::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Cloudpayments::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Cloudpayments::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Cloudpayments::Internal::Type::Converter
              ...
              Cloudpayments::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Cloudpayments::Internal::Type::Converter, T::Class[T.anything]) }
        end
