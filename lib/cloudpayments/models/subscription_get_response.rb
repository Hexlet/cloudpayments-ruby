...
module Cloudpayments
  module Models
    ...
    class SubscriptionGetResponse < Cloudpayments::Internal::Type::BaseModel
      # @!attribute success
      ...
      #
      #   @return [Cloudpayments::Models::SubscriptionGetResponse::Model, nil]
      optional :model, -> { Cloudpayments::Models::SubscriptionGetResponse::Model }, api_name: :Model
      ...
      #
      #   @param model [Cloudpayments::Models::SubscriptionGetResponse::Model] Модель подписки на рекуррентные платежи

      # @see Cloudpayments::Models::SubscriptionGetResponse#model
