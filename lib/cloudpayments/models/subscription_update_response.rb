...
module Cloudpayments
  module Models
    ...
    class SubscriptionUpdateResponse < Cloudpayments::Internal::Type::BaseModel
      # @!attribute success
      ...
      #
      #   @return [Cloudpayments::Models::SubscriptionUpdateResponse::Model, nil]
      optional :model, -> { Cloudpayments::Models::SubscriptionUpdateResponse::Model }, api_name: :Model
      ...
      #
      #   @param model [Cloudpayments::Models::SubscriptionUpdateResponse::Model] Модель подписки на рекуррентные платежи

      # @see Cloudpayments::Models::SubscriptionUpdateResponse#model
