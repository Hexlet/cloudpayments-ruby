  ...
  module Models
    ...
    module PaymentChargeResponse
      ...
      class UnionMember0 < Cloudpayments::Internal::Type::BaseModel
        ...
        #
        #   @return [Cloudpayments::Models::PaymentChargeResponse::UnionMember0::Model, nil]
        optional :model,
                 -> { Cloudpayments::Models::PaymentChargeResponse::UnionMember0::Model },
                 api_name: :Model
        ...
        #
        #   @param model [Cloudpayments::Models::PaymentChargeResponse::UnionMember0::Model] Модель транзакции в ответе API

        # @see Cloudpayments::Models::PaymentChargeResponse::UnionMember0#model
