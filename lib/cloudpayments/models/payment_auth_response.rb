...
module Cloudpayments
  module Models
    ...
    module PaymentAuthResponse
      ...
      # Базовый ответ API
      variant -> { Cloudpayments::Models::PaymentAuthResponse::UnionMember0 }

      # Базовый ответ API
      variant -> { Cloudpayments::Models::PaymentAuthResponse::UnionMember1 }
      ...
      class UnionMember0 < Cloudpayments::Internal::Type::BaseModel
        ...
        #
        #   @return [Cloudpayments::Models::PaymentAuthResponse::UnionMember0::Model, nil]
        optional :model, -> { Cloudpayments::Models::PaymentAuthResponse::UnionMember0::Model }, api_name: :Model
        ...
        #
        #   @param model [Cloudpayments::Models::PaymentAuthResponse::UnionMember0::Model] Модель транзакции в ответе API

        # @see Cloudpayments::Models::PaymentAuthResponse::UnionMember0#model
      ...
      class UnionMember1 < Cloudpayments::Internal::Type::BaseModel
        ...
        #
        #   @return [Cloudpayments::Models::PaymentAuthResponse::UnionMember1::Model, nil]
        optional :model, -> { Cloudpayments::Models::PaymentAuthResponse::UnionMember1::Model }, api_name: :Model
        ...
        #   @param message [String] Описание ошибки (при наличии)
        #
        #   @param model [Cloudpayments::Models::PaymentAuthResponse::UnionMember1::Model] Модель ответа, требующего 3-D Secure аутентификацию

        # @see Cloudpayments::Models::PaymentAuthResponse::UnionMember1#model
        class Model < Cloudpayments::Internal::Type::BaseModel
          # @!attribute acs_url
      ...
      #   @return [Array(Cloudpayments::Models::PaymentAuthResponse::UnionMember0, Cloudpayments::Models::PaymentAuthResponse::UnionMember1)]
    end
  end
end
