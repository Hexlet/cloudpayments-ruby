...
module Cloudpayments
  module Models
    # @see Cloudpayments::Resources::Subscriptions#create
    class SubscriptionCreateResponse < Cloudpayments::Internal::Type::BaseModel
      ...
      #
      #   @return [Cloudpayments::Models::SubscriptionCreateResponse::Model, nil]
      optional :model, -> { Cloudpayments::Models::SubscriptionCreateResponse::Model }, api_name: :Model
      ...
      #
      #   @param model [Cloudpayments::Models::SubscriptionCreateResponse::Model] Модель подписки на рекуррентные платежи

      # @see Cloudpayments::Models::SubscriptionCreateResponse#model
