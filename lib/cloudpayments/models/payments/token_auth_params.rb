...
module Cloudpayments
  module Models
    module Payments
      # @see Cloudpayments::Resources::Payments::Tokens#auth
      class TokenAuthParams < Cloudpayments::Internal::Type::BaseModel
        ...
        #
        #   @return [Cloudpayments::Models::Payments::TokenAuthParams::Payer, nil]
        optional :payer, -> { Cloudpayments::Payments::TokenAuthParams::Payer }, api_name: :Payer
