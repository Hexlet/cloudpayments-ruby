...
module Cloudpayments
  module Models
    ...
    class OrderCreateResponse < Cloudpayments::Internal::Type::BaseModel
      ...
      #   Модель заказа (счёта)
      #
      #   @return [Cloudpayments::Models::OrderCreateResponse::Model, nil]
      optional :model, -> { Cloudpayments::Models::OrderCreateResponse::Model }, api_name: :Model
      ...
      #
      #   @param model [Cloudpayments::Models::OrderCreateResponse::Model] Модель заказа (счёта)

      # @see Cloudpayments::Models::OrderCreateResponse#model
