...
module Cloudpayments
  module Models
    ...
    class SubscriptionFindResponse < Cloudpayments::Internal::Type::BaseModel
      ...
      #   Данные ответа
      #
      #   @return [Array<Cloudpayments::Models::SubscriptionFindResponse::Model>, nil]
      optional :model,
               -> { Cloudpayments::Internal::Type::ArrayOf[Cloudpayments::Models::SubscriptionFindResponse::Model] },
               api_name: :Model
      ...
      #
      #   @param model [Array<Cloudpayments::Models::SubscriptionFindResponse::Model>] Данные ответа
