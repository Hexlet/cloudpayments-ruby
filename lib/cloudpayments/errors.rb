  ...
  module Errors
    ...
    class APIStatusError < Cloudpayments::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          Cloudpayments::Errors::BadRequestError.new(**kwargs)
        in 401
          Cloudpayments::Errors::AuthenticationError.new(**kwargs)
        in 403
          Cloudpayments::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          Cloudpayments::Errors::NotFoundError.new(**kwargs)
        in 409
          Cloudpayments::Errors::ConflictError.new(**kwargs)
        in 422
          Cloudpayments::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          Cloudpayments::Errors::RateLimitError.new(**kwargs)
        in (500..)
          Cloudpayments::Errors::InternalServerError.new(**kwargs)
        else
          Cloudpayments::Errors::APIStatusError.new(**kwargs)
        end
      end
