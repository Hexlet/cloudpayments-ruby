...
module CloudpaymentsRuby
  module Models
    # Базовый ответ API
    #
    # @see CloudpaymentsRuby::Resources::Payments#auth
    module PaymentAuthResponse
      extend CloudpaymentsRuby::Internal::Type::Union

      # Базовый ответ API
      variant -> { CloudpaymentsRuby::Models::PaymentAuthResponse::UnionMember0 }

      # Базовый ответ API
      variant -> { CloudpaymentsRuby::Models::PaymentAuthResponse::UnionMember1 }
      ...
      class UnionMember1 < CloudpaymentsRuby::Internal::Type::BaseModel
        ...
        #
        #   @return [CloudpaymentsRuby::Models::PaymentAuthResponse::UnionMember1::Model, nil]
        optional :model,
        ...
        #   @param message [String] Описание ошибки (при наличии)
        #
        #   @param model [CloudpaymentsRuby::Models::PaymentAuthResponse::UnionMember1::Model] Модель ответа, требующего 3-D Secure аутентификацию

        # @see CloudpaymentsRuby::Models::PaymentAuthResponse::UnionMember1#model
      ...
      #   @return [Array(CloudpaymentsRuby::Models::PaymentAuthResponse::UnionMember0, CloudpaymentsRuby::Models::PaymentAuthResponse::UnionMember1)]
    end
  end
end
