...
module CloudpaymentsRuby
  module Models
    ...
    class PaymentAuthParams < CloudpaymentsRuby::Internal::Type::BaseModel
      ...
      #
      #   @return [CloudpaymentsRuby::Models::PaymentAuthParams::Payer, nil]
      optional :payer, -> { CloudpaymentsRuby::PaymentAuthParams::Payer }, api_name: :Payer
      ...
      #
      #   @return [Boolean, nil]
      optional :save_card, CloudpaymentsRuby::Internal::Type::Boolean, api_name: :SaveCard
