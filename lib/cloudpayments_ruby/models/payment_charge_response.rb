...
module CloudpaymentsRuby
  module Models
    # Базовый ответ API
    #
    # @see CloudpaymentsRuby::Resources::Payments#charge
    module PaymentChargeResponse
      extend CloudpaymentsRuby::Internal::Type::Union

      # Базовый ответ API
      variant -> { CloudpaymentsRuby::Models::PaymentChargeResponse::UnionMember0 }

      # Базовый ответ API
      variant -> { CloudpaymentsRuby::Models::PaymentChargeResponse::UnionMember1 }
      ...
      class UnionMember1 < CloudpaymentsRuby::Internal::Type::BaseModel
        ...
        #
        #   @return [CloudpaymentsRuby::Models::PaymentChargeResponse::UnionMember1::Model, nil]
        optional :model,
        ...
        #   @param message [String] Описание ошибки (при наличии)
        #
        #   @param model [CloudpaymentsRuby::Models::PaymentChargeResponse::UnionMember1::Model] Модель ответа, требующего 3-D Secure аутентификацию

        # @see CloudpaymentsRuby::Models::PaymentChargeResponse::UnionMember1#model
      ...
      #   @return [Array(CloudpaymentsRuby::Models::PaymentChargeResponse::UnionMember0, CloudpaymentsRuby::Models::PaymentChargeResponse::UnionMember1)]
    end
  end
end
