...
module CloudpaymentsRuby
  module Models
    module Payments
      # @see CloudpaymentsRuby::Resources::Payments::Tokens#charge
      class TokenChargeParams < CloudpaymentsRuby::Internal::Type::BaseModel
        ...
        #
        #   @return [CloudpaymentsRuby::Models::Payments::TokenChargeParams::Payer, nil]
        optional :payer, -> { CloudpaymentsRuby::Payments::TokenChargeParams::Payer }, api_name: :Payer
