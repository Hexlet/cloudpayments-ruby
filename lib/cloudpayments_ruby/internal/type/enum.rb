    ...
    module Type
      ...
      module Enum
        ...
        def ==(other)
          ...
          CloudpaymentsRuby::Internal::Type::Enum === other && other.values.to_set == values.to_set
        ...
        def inspect(depth: 0)
          ...
          members = values.map { CloudpaymentsRuby::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
