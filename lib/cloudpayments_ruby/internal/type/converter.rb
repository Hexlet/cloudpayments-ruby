    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { CloudpaymentsRuby::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { CloudpaymentsRuby::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            CloudpaymentsRuby::FilePart.new(value)
          in CloudpaymentsRuby::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in CloudpaymentsRuby::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [CloudpaymentsRuby::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: CloudpaymentsRuby::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in CloudpaymentsRuby::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in CloudpaymentsRuby::Internal::Type::Converter
              ...
              CloudpaymentsRuby::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(CloudpaymentsRuby::Internal::Type::Converter, T::Class[T.anything]) }
        end
