    ...
    module Util
      ...
      class << self
        ...
        def encode_content(headers, body)
          ...
          in [CloudpaymentsRuby::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [CloudpaymentsRuby::Internal::Util::JSONL_CONTENT, Enumerable] unless CloudpaymentsRuby::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | CloudpaymentsRuby::Internal::Type::FileInput]
          ...
          in [_, StringIO]
            [headers, body.string]
          in [_, CloudpaymentsRuby::FilePart]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in CloudpaymentsRuby::Internal::Util::JSON_CONTENT
          ...
          in CloudpaymentsRuby::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [CloudpaymentsRuby::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in CloudpaymentsRuby::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
