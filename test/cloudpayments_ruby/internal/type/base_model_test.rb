...
class CloudpaymentsRuby::Test::PrimitiveModelTest < Minitest::Test
  A = CloudpaymentsRuby::Internal::Type::ArrayOf[-> { Integer }]
  H = CloudpaymentsRuby::Internal::Type::HashOf[-> { Integer }, nil?: true]

  module E
    extend CloudpaymentsRuby::Internal::Type::Enum
  end
  ...
  class B < CloudpaymentsRuby::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      CloudpaymentsRuby::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => CloudpaymentsRuby::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [CloudpaymentsRuby::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [CloudpaymentsRuby::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [CloudpaymentsRuby::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = CloudpaymentsRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        CloudpaymentsRuby::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [CloudpaymentsRuby::Internal::Type::Boolean, true] => true,
      [CloudpaymentsRuby::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => CloudpaymentsRuby::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        CloudpaymentsRuby::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = CloudpaymentsRuby::Internal::Type::Converter.new_coerce_state
      CloudpaymentsRuby::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        CloudpaymentsRuby::Internal::Type::Converter.dump(target, input, state: state)
...
class CloudpaymentsRuby::Test::EnumModelTest < Minitest::Test
  class E0
    include CloudpaymentsRuby::Internal::Type::Enum
...
class CloudpaymentsRuby::Test::CollectionModelTest < Minitest::Test
  A1 = CloudpaymentsRuby::Internal::Type::ArrayOf[-> { Integer }]
  H1 = CloudpaymentsRuby::Internal::Type::HashOf[Integer]

  A2 = CloudpaymentsRuby::Internal::Type::ArrayOf[H1]
  H2 = CloudpaymentsRuby::Internal::Type::HashOf[-> { A1 }]

  A3 = CloudpaymentsRuby::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = CloudpaymentsRuby::Internal::Type::HashOf[Integer, nil?: true]
...
class CloudpaymentsRuby::Test::BaseModelTest < Minitest::Test
  class M1 < CloudpaymentsRuby::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < CloudpaymentsRuby::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < CloudpaymentsRuby::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, CloudpaymentsRuby::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = CloudpaymentsRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = CloudpaymentsRuby::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(CloudpaymentsRuby::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue CloudpaymentsRuby::Errors::ConversionError => e
...
class CloudpaymentsRuby::Test::UnionTest < Minitest::Test
  class U0
    include CloudpaymentsRuby::Internal::Type::Union
  ...
  class M2 < CloudpaymentsRuby::Internal::Type::BaseModel
  ...
  class M4 < CloudpaymentsRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, CloudpaymentsRuby::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < CloudpaymentsRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, CloudpaymentsRuby::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class CloudpaymentsRuby::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include CloudpaymentsRuby::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [CloudpaymentsRuby::Internal::Type::Unknown, CloudpaymentsRuby::Internal::Type::Unknown] => true,
      [CloudpaymentsRuby::Internal::Type::Boolean, CloudpaymentsRuby::Internal::Type::Boolean] => true,
      [CloudpaymentsRuby::Internal::Type::Unknown, CloudpaymentsRuby::Internal::Type::Boolean] => false,
...
class CloudpaymentsRuby::Test::MetaInfoTest < Minitest::Test
  A1 = CloudpaymentsRuby::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = CloudpaymentsRuby::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
