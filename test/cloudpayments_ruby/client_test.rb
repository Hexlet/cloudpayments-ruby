...
class CloudpaymentsRubyTest < Minitest::Test
  ...
  def test_client_redirect_307
    ...
    assert_raises(CloudpaymentsRuby::Errors::APIConnectionError) do
      cloudpayments.payments.charge(
        amount: 0,
        card_cryptogram_packet: "CardCryptogramPacket",
        ip_address: "IpAddress",
    ...
    assert_requested(:any, "http://localhost/redirected", times: CloudpaymentsRuby::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: CloudpaymentsRuby::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(
      ...
      times: CloudpaymentsRuby::Client::MAX_REDIRECTS
    ) do
      headers = _1.headers.keys.map(&:downcase)
