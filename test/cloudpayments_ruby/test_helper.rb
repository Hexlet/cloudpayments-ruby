...
class CloudpaymentsRuby::Test::SingletonClient < CloudpaymentsRuby::Client
  include Singleton
  ...
  def initialize
    super(
      base_url: CloudpaymentsRuby::Test::SingletonClient::TEST_API_BASE_URL,
...
class CloudpaymentsRuby::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @cloudpayments = CloudpaymentsRuby::Test::SingletonClient.instance
  end
