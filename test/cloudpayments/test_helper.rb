...
class Cloudpayments::Test::SingletonClient < Cloudpayments::Client
  include Singleton
...
class Cloudpayments::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @cloudpayments = Cloudpayments::Test::SingletonClient.instance
  end
