...
class Cloudpayments::Test::PrimitiveModelTest < Minitest::Test
  A = Cloudpayments::Internal::Type::ArrayOf[-> { Integer }]
  H = Cloudpayments::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Cloudpayments::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Cloudpayments::Internal::Type::Unknown,
      Cloudpayments::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Cloudpayments::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Cloudpayments::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Cloudpayments::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Cloudpayments::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Cloudpayments::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Cloudpayments::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Cloudpayments::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Cloudpayments::Internal::Type::Boolean, true] => true,
      [Cloudpayments::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Cloudpayments::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Cloudpayments::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Cloudpayments::Internal::Type::Converter.new_coerce_state
      Cloudpayments::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Cloudpayments::Internal::Type::Converter.dump(target, input, state: state)
...
class Cloudpayments::Test::EnumModelTest < Minitest::Test
  class E0
    include Cloudpayments::Internal::Type::Enum
...
class Cloudpayments::Test::CollectionModelTest < Minitest::Test
  A1 = Cloudpayments::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Cloudpayments::Internal::Type::HashOf[Integer]

  A2 = Cloudpayments::Internal::Type::ArrayOf[H1]
  H2 = Cloudpayments::Internal::Type::HashOf[-> { A1 }]

  A3 = Cloudpayments::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Cloudpayments::Internal::Type::HashOf[Integer, nil?: true]
...
class Cloudpayments::Test::BaseModelTest < Minitest::Test
  class M1 < Cloudpayments::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Cloudpayments::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Cloudpayments::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Cloudpayments::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Cloudpayments::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Cloudpayments::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Cloudpayments::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Cloudpayments::Errors::ConversionError => e
...
class Cloudpayments::Test::UnionTest < Minitest::Test
  class U0
    include Cloudpayments::Internal::Type::Union
  ...
  class M2 < Cloudpayments::Internal::Type::BaseModel
  ...
  class M4 < Cloudpayments::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Cloudpayments::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Cloudpayments::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Cloudpayments::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Cloudpayments::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Cloudpayments::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Cloudpayments::Internal::Type::Unknown, Cloudpayments::Internal::Type::Unknown] => true,
      [Cloudpayments::Internal::Type::Boolean, Cloudpayments::Internal::Type::Boolean] => true,
      [Cloudpayments::Internal::Type::Unknown, Cloudpayments::Internal::Type::Boolean] => false,
...
class Cloudpayments::Test::MetaInfoTest < Minitest::Test
  A1 = Cloudpayments::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Cloudpayments::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
