...
class Cloudpayments::Test::Resources::SubscriptionsTest < Cloudpayments::Test::ResourceTest
  def test_create_required_params
    ...
    assert_pattern do
      response => Cloudpayments::Models::SubscriptionCreateResponse
    end
  ...
  def test_update_required_params
    ...
    assert_pattern do
      response => Cloudpayments::Models::SubscriptionUpdateResponse
    end
  ...
  def test_cancel_required_params
    ...
    assert_pattern do
      response => Cloudpayments::Models::SubscriptionCancelResponse
    end
  ...
  def test_find_required_params
    ...
    assert_pattern do
      response => Cloudpayments::Models::SubscriptionFindResponse
    end
  ...
  def test_get_required_params
    ...
    assert_pattern do
      response => Cloudpayments::Models::SubscriptionGetResponse
    end
